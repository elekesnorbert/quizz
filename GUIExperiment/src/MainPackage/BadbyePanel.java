 ...
 */
public class BadbyePanel extends JPanel
{
  ...
  public BadbyePanel(ActionListener actionListener, String name, String choice)
  {
    super();
    ...
    labelOne = new JLabel("Really, " + name + "?");
    labelOne.setFont(new Font("Times New Roman", Font.PLAIN, 25));
    labelOne.setBounds(100, 90, 300, 30);
    this.add(labelOne);

    labelTwo = new JLabel(choice + " is kinda lame :/");
    labelTwo.setFont(new Font("Arial", Font.PLAIN, 17));
    labelTwo.setBounds(107, 140, 300, 20);
    this.add(labelTwo);
